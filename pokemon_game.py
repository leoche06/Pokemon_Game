...
class pokedex:
    def __init__(self):
        ...
        for i in CHARACTERS:
            self.pokemons.append(pokemon(i, CHARACTERS[i]['Type'], CHARACTERS[i]['HP'], CHARACTERS[i]['Attack'], CHARACTERS[i]['Defense'], CHARACTERS[i]['Speed'], CHARACTERS[i]['Experience'], CHARACTERS[i]['Moves'], 1))
